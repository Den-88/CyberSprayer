...
def main():
    ...
    # cap = cv2.VideoCapture("rtspsrc location=rtsp://192.168.0.17:8554/profile0 ! decodebin ! videoconvert ! appsink",
    #                        cv2.CAP_GSTREAMER)

    cap = cv2.VideoCapture(
        "rtspsrc location=rtsp://192.168.0.17:8554/profile0 protocols=tcp latency=10 ! rtph265depay ! h265parse ! avdec_h265 ! videoconvert ! appsink",
        cv2.CAP_GSTREAMER)
