...
def main():
    ...
    while running:
        ...
        # Если обработка задержалась, пропускаем кадры
        if elapsed_time > frame_interval:
            ...
            last_processed_time = current_time  # Обновляем время, сбрасывая задержку
            continue  # Пропускаем итерацию, чтобы не обрабатывать старый кадр
        ...
        print(f"Frame processed in {end_time - current_time:.4f} seconds")
